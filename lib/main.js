...
// The actions that mean "I am working on this project now".
const OPENING_MODES = new Set([
  "open-in-new-window",
  "open-in-this-window",
  "open-in-dev-mode",
  "open-in-safe-mode",
...
class ProjectList {
    ...
    this.disposables.add(
      lumine.commands.add("lumine-workspace", {
        ...
        "project-list:clear-recent": {
          description: "Forget the recently opened projects kept at the top of the list.",
  ...
  performAction(mode) {
    ...
    // Only the modes that actually open the project count as using it;
    // copying its paths or revealing its folder does not.
    if (OPENING_MODES.has(mode)) {
